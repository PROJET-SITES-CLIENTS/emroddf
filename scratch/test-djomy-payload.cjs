...
async function run() {
  ...
  const payload = {
    ...
    // Testing all possible reference fields
    merchantPaymentReference: 'EMROD-123',
    merchantReference: 'EMROD-123',
    reference: 'EMROD-123',
    paymentReference: 'EMROD-123',
    orderId: 'EMROD-123',
    transactionReference: 'EMROD-123',
