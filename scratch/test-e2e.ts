...
async function main() {
  ...
  const login = (await import('../api/_routes/admin/login')).default;
  const session = (await import('../api/_routes/admin/session')).default;
  const logout = (await import('../api/_routes/admin/logout')).default;
  const categoriesH = (await import('../api/_routes/admin/categories')).default;
  const categoryH = (await import('../api/_routes/admin/categories/[id]')).default;
  const productsH = (await import('../api/_routes/admin/products')).default;
  const productH = (await import('../api/_routes/admin/products/[id]')).default;
  const productImagesH = (await import('../api/_routes/admin/products/[id]/images')).default;
  const imageH = (await import('../api/_routes/admin/images/[imageId]')).default;
  const galleryH = (await import('../api/_routes/admin/gallery')).default;
  const galleryItemH = (await import('../api/_routes/admin/gallery/[id]')).default;
  const galleryReorderH = (await import('../api/_routes/admin/gallery/reorder')).default;
  const leadsH = (await import('../api/_routes/admin/leads')).default;
  const leadH = (await import('../api/_routes/admin/leads/[id]')).default;
  const ordersH = (await import('../api/_routes/admin/orders')).default;
  const orderH = (await import('../api/_routes/admin/orders/[id]')).default;
  const settingsAdminH = (await import('../api/_routes/admin/settings')).default;
  const statsH = (await import('../api/_routes/admin/stats')).default;
  const catalogueH = (await import('../api/_routes/public/catalogue')).default;
  const productPublicH = (await import('../api/_routes/public/product/[categorySlug]/[modelSlug]')).default;
  const galleryPublicH = (await import('../api/_routes/public/gallery')).default;
  const settingsPublicH = (await import('../api/_routes/public/settings')).default;
  const leadsPublicH = (await import('../api/_routes/public/leads')).default;
  const paymentCreateH = (await import('../api/_routes/payment/create')).default;
  const webhookH = (await import('../api/_routes/payment/webhook')).default;
  const publicOrdersH = (await import('../api/_routes/public/orders')).default;
  const passwordH = (await import('../api/_routes/admin/password')).default;
  const testEmailH = (await import('../api/_routes/admin/test-email')).default;
