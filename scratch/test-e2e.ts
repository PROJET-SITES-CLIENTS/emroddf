...
async function main() {
  ...
  const login = (await import('../api/router')).login;
  const session = (await import('../api/router')).session;
  const logout = (await import('../api/router')).logout;
  const categoriesH = (await import('../api/router')).categories;
  const categoryH = (await import('../api/router')).categoryItem;
  const productsH = (await import('../api/router')).products;
  const productH = (await import('../api/router')).productItem;
  const productImagesH = (await import('../api/router')).productImages;
  const imageH = (await import('../api/router')).imageItem;
  const galleryH = (await import('../api/router')).gallery;
  const galleryItemH = (await import('../api/router')).galleryItem;
  const galleryReorderH = (await import('../api/router')).galleryReorder;
  const leadsH = (await import('../api/router')).leads;
  const leadH = (await import('../api/router')).leadItem;
  const ordersH = (await import('../api/router')).orders;
  const orderH = (await import('../api/router')).orderItem;
  const settingsAdminH = (await import('../api/router')).settingsAdmin;
  const statsH = (await import('../api/router')).stats;
  const catalogueH = (await import('../api/router')).catalogue;
  const productPublicH = (await import('../api/router')).productPublic;
  const galleryPublicH = (await import('../api/router')).galleryPublic;
  const settingsPublicH = (await import('../api/router')).settingsPublic;
  const leadsPublicH = (await import('../api/router')).leadsPublic;
  const paymentCreateH = (await import('../api/router')).paymentCreate;
  const webhookH = (await import('../api/router')).paymentWebhook;
  const publicOrdersH = (await import('../api/router')).ordersPublic;
  const passwordH = (await import('../api/router')).password;
  const testEmailH = (await import('../api/router')).testEmail;
  const { computeDeposit } = await import('../api/router');
